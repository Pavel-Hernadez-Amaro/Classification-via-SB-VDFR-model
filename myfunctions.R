...
pca.nomiss.class2_lda <- function(x, y, maxi, t.par, lambda.sm){      
...
pca.miss.james_lda <- function(x, y, maxi, t.par, k){      
...
pca.miss.yao2_lda <- function(x, y, maxi, t.par, bwmean, bwcov){     # pca WITH missing data, Yao method
...
pca.miss.buja2_lda <- function(x, y, maxi, t.par, lambda.buja){     
